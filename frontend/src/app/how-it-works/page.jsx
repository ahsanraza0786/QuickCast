    ...
    <div className="min-h-screen bg-gray-50">
              ...
              <div key={step.id} className={`flex flex-col ${index % 2 === 1 ? 'md:flex-row-reverse' : 'md:flex-row'} gap-8 md:gap-12 items-center`}>
                <div className="md:w-1/2">
                  <div className="relative h-64 md:h-80 w-full rounded-xl overflow-hidden shadow-lg">
                    ...
                    {/* <Image
                      ...
                      objectFit="cover"
                    /> */}
                    {/* For now, using colored divs with numbers as placeholders */}
                    <div className={`absolute inset-0 ${index % 2 === 0 ? 'bg-blue-500' : 'bg-indigo-600'} flex items-center justify-center`}>
                      <div className="text-white text-9xl font-bold opacity-30">{step.id}</div>
                      <div className="absolute inset-0 flex items-center justify-center">
                        <div className="text-white text-center p-4">
                          <div className="text-5xl mb-4">{['✏️', '🔗', '🎯', '📊'][index]}</div>
                ...
                <div className="md:w-1/2">
                  <div className="bg-white p-6 md:p-8 rounded-xl shadow-md">
                    <div className="inline-block bg-blue-100 text-blue-800 font-bold rounded-full px-4 py-1 text-sm mb-4">Step {step.id}</div>
      ...
      <div className="bg-gray-100 py-20">
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto">
            <h2 className="text-3xl font-bold text-center text-gray-800 mb-4">Perfect For Any Presentation Setting</h2>
        ...
        <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-lg overflow-hidden">
          <div className="md:flex">
            <div className="md:w-1/3 bg-indigo-600">
              {/* If you have an actual testimonial image, use Next.js Image */}
              ...
              <div className="h-48 md:h-full flex items-center justify-center">
                <div className="text-white text-center p-6">
                  <div className="w-20 h-20 rounded-full bg-indigo-400 mx-auto mb-4 flex items-center justify-center">
            ...
            <div className="p-8 md:p-12 md:w-2/3">
              ...
              <div>
                ...
                <p className="text-gray-600">VP of Sales, TechInnovate Inc.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="bg-gradient-to-br from-indigo-600 to-purple-700 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link href="/signup" className="bg-white text-indigo-600 hover:bg-gray-100 transition-colors font-semibold py-3 px-8 rounded-lg shadow-md hover:shadow-lg">
              Get Started Free
            </Link>
            <Link href="/demo" className="bg-transparent hover:bg-indigo-500 transition-colors border-2 border-white font-semibold py-3 px-8 rounded-lg">
              See a Demo
            </Link>
          </div>
        </div>
