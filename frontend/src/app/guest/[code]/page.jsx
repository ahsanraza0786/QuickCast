...
//               setParticipants(detailedRoom.participants);
//             }
//             toast.success('Welcome back, Presenter!');
//           }
//         } catch (authErr) {
//           console.error('Presenter auth error:', authErr.response?.data);
//           setIsAdmin(false);
...
//           <div className="flex rounded-lg bg-white/80 backdrop-blur-sm p-1 shadow-md">
//             <button
...
//           {/* Polls Section */}
//           <div className={activeTab === 'polls' ? 'block' : 'hidden md:block'}>
//             <motion.div
//               initial={{ opacity: 0, y: 20 }}
//               animate={{ opacity: 1, y: 0 }}
